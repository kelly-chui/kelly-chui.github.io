...
![](/images/tistory/tistory-167-프로그래머스-최고의-집합/image-001.png)
...
![](/images/tistory/tistory-167-프로그래머스-최고의-집합/image-002.png)

여기서 함수 f(x)는 2차 함수고 a의 계수가 마이너스 이므로 아래로 열려있는 포물선이다. 따라서 꼭짓점 부분이 최대값이 된다. 그 꼭짓점 부분은 쉽게 대수적으로 구할 수 있다.

![](/images/tistory/tistory-167-프로그래머스-최고의-집합/image-003.png)

다음 그래프는 s = 10일때의 그래프이다. 가로 축은 a, 세로 축은 곱의 최대값을 의미한다:

![](/images/tistory/tistory-167-프로그래머스-최고의-집합/image-004.png)
