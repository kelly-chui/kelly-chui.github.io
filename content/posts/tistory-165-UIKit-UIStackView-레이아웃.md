...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-001.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-002.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-003.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-004.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-005.png)

`ColorView`의 기본 intrinsic size를 `(100, 100)`으로 설정했지만, 스택 뷰의 가로 길이에 맞추기 위해 `redView`의 길이가 늘어난 것을 볼 수 있다.

![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-006.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-007.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-008.png)

`redView`, `greenView`, `blueView`의 너비를 각각 50, 100, 150으로 설정했기 때문에 비율은 1:2:3이다.

![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-009.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-010.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-011.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-012.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-013.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-014.png)

#### top / leading

![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-015.png)

#### bottom / trailing

![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-016.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-017.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-018.png)

뷰들이 수축되는 현상이 일어난다. 뷰 사이의 간격이 정말 100인지 확인해보면 다음과 같다. iPhone SE 3의 가로 길이는 375pt이다.

![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-019.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-020.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-021.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-022.png)
...
![](/images/tistory/tistory-165-UIKit-UIStackView-레이아웃/image-023.png)
