---
title: "dev-data-server-light (6). Json 영속성"
...
이번 포스트에서는 dev-data-server-light에 DB, Storage, Token Storage에서 영속성을 가진 저장 방식을 구현해서 in-memory 대신 사용할 수 있도록 만든다.

프로토타입이었던 dev-data-server에서는 시작부터 SQL 의존성을 가지고 시작했지만, dev-data-server-light는 아주 얇은 in-memory 구현만 가지고 있다.
