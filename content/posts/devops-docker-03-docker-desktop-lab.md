...
![image.png](/images/devops-docker-03-docker-desktop-lab/image-001.png)

## Docker Desktop 사용해보기

![image.png](/images/devops-docker-03-docker-desktop-lab/image-002.png)

### 컨테이너 탭

![image.png](/images/devops-docker-03-docker-desktop-lab/image-006.png)
...
![image.png](/images/devops-docker-03-docker-desktop-lab/image-003.png)

`backend/src/routes/getGreetings.js` 파일을 수정해서, 앱 UI를 변화시켜본다.

![image.png](/images/devops-docker-03-docker-desktop-lab/image-004.png)

도커를 재시작 하지 않고 새로고침만으로 프론트엔드에 반영된 것을 확인할 수 있다.

![image.png](/images/devops-docker-03-docker-desktop-lab/image-005.png)
