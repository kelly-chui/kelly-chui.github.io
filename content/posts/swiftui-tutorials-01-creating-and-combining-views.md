...
![](/images/swiftui-tutorials-01-creating-and-combining-views/image-001.png)

캔버스 모드를 Selectable로 변경한다. (캔버스는 기본적으로 라이브 모드이다. 편집하려면 Selectable로 변경해야한다.)

### Step 2

![](/images/swiftui-tutorials-01-creating-and-combining-views/image-002.png)

프리뷰에서 인사 문구(Hello SwiftUI)를 Command-Control-click 하면, 구조화된 편집 팝오버가 열린다, 그리고 “Show SwiftUI Inspector”를 고른다.

### Step 3, 4

![](/images/swiftui-tutorials-01-creating-and-combining-views/image-003.png)
...
![](/images/swiftui-tutorials-01-creating-and-combining-views/image-004.png)
...
![](/images/swiftui-tutorials-01-creating-and-combining-views/image-005.png)

### Step 2-5

Xcode 윈도우 우상단의 + 버튼을 클릭하여 라이브러리를 연다. 그리고 `Text` 뷰를 “Turtle Rock” 텍스트 뷰의 아래로 드래그한다.

![](/images/swiftui-tutorials-01-creating-and-combining-views/image-006.png)
...
![](/images/swiftui-tutorials-01-creating-and-combining-views/image-007.png)
...
![](/images/swiftui-tutorials-01-creating-and-combining-views/image-008.png)
...
![](/images/swiftui-tutorials-01-creating-and-combining-views/image-009.png)
...
![](/images/swiftui-tutorials-01-creating-and-combining-views/image-010.png)
