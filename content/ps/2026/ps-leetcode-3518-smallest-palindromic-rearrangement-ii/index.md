...
original: ""
aliases:
  - /posts/ps-leetcode-3518-smallest-palindromic-rearrangement-ii/
---
...
[1번 문제]({{< relref "ps/2026/ps-leetcode-3517-smallest-palindromic-rearrangement-i" >}})와 마찬가지로 팰린드롬의 성질상 절반만 결정하면 전체가 결정된다. 따라서 이 문제는 절반 문자열의 `k`번째 사전순 순열을 구하는 문제로 단순화된다.
